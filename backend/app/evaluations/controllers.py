...
# Stripping these from a blanket POST/PUT blocks a coach forging the committee
# signature / self-approving via create or update (security audit 2026-06-15, CRITICAL).
_SIGNOFF_FIELDS = {
    "coach_signed",
    "coach_signed_date",
    "committee_signed",
