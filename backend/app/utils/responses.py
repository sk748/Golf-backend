...
USER_DOES_NOT_EXIST = {"http_code": 404, "code": "test_stat", "message": "Does not exists."}
NOT_ADMIN = {"http_code": 403, "code": "test_stat", "message": "Admin permission denied."}
HEADER_NOT_FOUND = {"http_code": 404, "code": "test_stat", "message": "Header does not exists."}
PERMISSION_DENIED = {"http_code": 404, "code": "test_stat", "message": "User permissions denied."}
CREDENTIALS_ERROR_999 = {"http_code": 400, "code": "test_stat", "message": "Credentials error."}
